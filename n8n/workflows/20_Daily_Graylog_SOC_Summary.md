# Daily Graylog SOC Summary

## Objective

Create a scheduled SOC summary using Graylog event data.

## Graylog Event Condition

```text
Scheduled daily workflow; Graylog queried through API/search endpoint
```

## n8n Nodes

1. Schedule Trigger
2. HTTP Request — Graylog API
3. Aggregate events
4. Code / Edit Fields — summary
5. Email / Teams
6. Optional Grafana link
...
Email / Teams
     ↓
Grafana / Graylog Links
```

## Configuration Steps

1. Use a Schedule Trigger to run once per day.
2. Query Graylog for the previous reporting period.
3. Calculate counts such as total events, critical events, top sources, and top event types.
4. Format a concise SOC summary.
5. Send it by email or collaboration platform.
6. Include links to Graylog searches or Grafana dashboards for deeper investigation.
